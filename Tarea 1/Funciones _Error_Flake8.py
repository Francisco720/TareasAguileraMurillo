...
""" Descripción: Verifica que la entrada sea una string sin números y luego se invierte cada carácter de mayúscula a minúscula y viceversa, en caso de no cumplirse lo primero se retorna un código de error."""
